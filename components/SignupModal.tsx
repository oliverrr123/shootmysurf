  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPortal>
        ...
        <DialogContent className="fixed inset-x-4 top-1/2 left-1/2 z-50 w-full max-w-md bg-white rounded-3xl shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 border-0 p-0 max-h-[calc(100vh-6rem)] overflow-y-auto sm:inset-x-auto sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-h-[90vh] sm:w-full">
