  ...
  ({ className, variant, size, asChild = false, children, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        {...props}
      >
        <span className="btn-content inline-flex items-center gap-2">{children}</span>
      </Comp>
    )
  }
)
